...
class QLoRATrainer:
    ...
    def load_dataset(self):
        try:
            ...
            print("\n")
            print(f"[INFO] Dataset '{self.dataset_name}' loaded successfully.")
            print("\n")
    ...
    def setup_trainer(self):
        try:
            ...
            print("\n")
            print(f"[ERROR] Failed to setup trainer: {e}")
            print("\n")
            sys.exit(1)
    ...
    def train(self):
        try:
            ...
            print("\n")
            print(f"[INFO] Model trained and saved as '{self.new_model_name}'.")
            print("\n")
        except Exception as e:
            print("\n")
    ...
    def push_to_hub(self, hub_name: str):
        try:
            ...
            print("\n")
            print(f"[INFO] Model and tokenizer pushed to hub: {hub_name}")
            print("\n")
        except Exception as e:
            print("\n")
...
if __name__ == "__main__":
    try:
        ...
        print("\n")
        print(f"[FATAL ERROR] Unexpected failure: {main_e}")
        print("\n")
        sys.exit(1)
